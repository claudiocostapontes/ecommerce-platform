...
public class OrderService {
    ...
    public OrderResponse createOrder(
        ...
        /*
         * O pedido precisa ter um UUID antes de registrar
         * movimentos/reservas de estoque vinculados a ele.
         */
    ...
    @Transactional(readOnly = true)
    public PageResponse<OrderResponse> getOrdersByStatus(
            OrderStatus status,
            Pageable pageable
    ) {
        Page<Order> page =
    ...
    private void validateCartOwnership(
        ...
        if (cart.getUser() == null
            ...
            /*
             * Retornamos como "não encontrado" para não revelar
             * a existência de carrinhos pertencentes a terceiros.
             */
    ...
    private void validateOrderOwnership(
        ...
        if (order.getUser() == null
            ...
            /*
             * Não revela que o pedido existe para outro usuário.
             */
            throw new ResourceNotFoundException(
                    "Order",
                    order.getId()
